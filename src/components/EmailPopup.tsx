...
const GOOGLE_SHEET_URL =
  "https://script.google.com/macros/s/AKfycbzXvqLXt-aMgqMf6NBbHTMrqFLHj5X3GJzHqLqj0mHCzFKFSGLXNVZO2Bd7bH_8aPYS/exec";
...
export default function EmailPopup() {
  ...
  return (
    <div className="fixed inset-0 z-[9998] flex items-center justify-center px-4">
      ...
      {/* Popup */}
      <div
        className="relative bg-white rounded-2xl shadow-2xl p-6 w-full max-w-[340px] pop-in"
      >
        {/* Close button */}
        <button
          onClick={() => setDismissed(true)}
        ...
        {/* Content */}
        <h3
          className="text-[15px] font-semibold text-gray-900 leading-tight pr-6 mb-1"
        >
