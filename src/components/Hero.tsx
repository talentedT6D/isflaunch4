...
export default function Hero() {
  return (
    <section className="relative h-[85vh] min-h-[500px] md:h-screen md:min-h-[600px] md:max-h-[980px] overflow-hidden">
      {/* Image background */}
      ...
      <div className="absolute inset-0 z-10 flex items-center justify-center pointer-events-none px-4 pt-16 md:pt-20">
        <div className="flex flex-col items-center">
          <img
            ...
            className="w-[85vw] sm:w-[60vw] md:w-[56vw] lg:w-[48vw] h-auto"
          />
          ...
          >
            <img
              ...
              className="w-[220px] sm:w-[230px] md:w-[280px] lg:w-[330px] h-auto hover:brightness-110 hover:-translate-y-0.5 transition-all duration-300"
            />
          </a>
        </div>
      </div>
