    ...
    <footer className="bg-black border-t border-white/10">
      ...
      <div className="md:hidden px-6 py-8 flex flex-col items-center gap-6 text-center">
        ...
        <div className="flex items-center gap-6">
          <button
            ...
            className="text-[12px] uppercase text-white/70 hover:text-white transition-colors cursor-pointer"
            style={{ fontFamily: "obviously-narrow", fontWeight: 400 }}
          >
            Terms & Conditions
          </button>
      ...
      <div className="hidden md:flex max-w-[1440px] mx-auto px-[32px] py-6 items-center justify-between gap-6">
        ...
        <div className="flex items-center gap-6">
          <button
            onClick={onTermsClick}
            className="text-[18px] text-white capitalize hover:text-white/80 transition-colors cursor-pointer"
            style={{ fontFamily: "obviously-narrow", fontWeight: 400 }}
          >
            Terms & Conditions
          </button>
